...
export const PAGE_TOURS = {
  ...
  annotation_2d: [
    ...
    },
    {
      ...
      text: "Beyond the two jaw scans, a case has four named STL slots — an Upper jaw and Lower jaw, each with a framework slot beside it, named Metal RPD or Monoblock after the case's material. This tab lists them over the 3D view: upload one and it takes the stage, a file's icon hides it in the view and the trash button removes it.",
    ...
    },
    {
      ...
      text: "Load Proposed Design sends the current tooth presence, jaw type, and material to the design DLL and places what comes back on the arch — there's no confirmation step, so undo is the way back. If the DLL is unavailable, the local Kennedy proposal is placed instead. Draw from Scratch clears the arch so you build the design up yourself. Both sit above the Clear buttons and, like them, only appear in design mode.",
