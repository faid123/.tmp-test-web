...
export const HELP_TOPICS = [
  ...
  },
  {
    ...
    answer:
      "Select a case, then use the pencil beside STATUS in the detail panel to pick a new one. The statuses run Draft → 2D design pending/drafted/approved → 3D design pending/drafted/approved → In production → Out for delivery → Delivered → Completed.",
    steps: [
      "Select the case in the list.",
      "In the detail panel on the right, select the pencil next to STATUS.",
      "Pick the new status — it saves immediately.",
    ],
  ...
  },
  {
    ...
    answer:
      "The ☰ button beside the case name opens the case-actions menu: View Dashboard, Rename, Edit User Access, View Version History, Download 2D Design L2, Duplicate and Delete.",
    steps: [
      "Select a case so the detail panel appears.",
      "Select the ☰ button beside the case name.",
    ],
    related: ["rename-case", "duplicate-case", "delete-case", "download-2d", "user-access", "dashboard"],
  },
  {
    id: "duplicate-case",
  ...
  },
  {
    ...
    answer:
      "Download 2D Design L2 in the case-actions menu saves the case's 2D design data as a file.",
    steps: [
      "Select the case in the list.",
      "Open the ☰ menu beside the case name.",
      "Choose Download 2D Design L2.",
    ],
  ...
  },
  {
    ...
    related: ["return-to-list", "version-history", "download-2d"],
  },
  {
    id: "return-to-list",
