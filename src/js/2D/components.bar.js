...
export const BAR_PLACEMENT_OFFSET_BY_TOOTH_SURFACE = Object.freeze({
  "11": {
    bar_d1_mesial: { x: 12, y: -11, rotation: 3 },
    bar_d1_distal: { x: -45, y: -2, rotation: -22 },
    bar_d2_mesial: { x: 35, y: -4, rotation: -2 },
    bar_d2_distal: { x: -58, y: 15, rotation: -3 },
  },
  "21": {
    bar_d1_mesial: { x: 12, y: -11, rotation: -3 },
    bar_d1_distal: { x: -45, y: -2, rotation: 22  },
  ...
  "12": {
    bar_d1_mesial: { x: 0, y: -24, rotation: 14 },
    bar_d1_distal: { x: -30, y: -4, rotation: -20 },
    bar_d2_mesial: { x: 21, y: -24, rotation: 3 },
    bar_d2_distal: { x: -55, y: 20, rotation: -1 },
  },
  "22": {
    bar_d1_mesial: { x: 0, y: -24, rotation: -14 },
    bar_d1_distal: { x: -30, y: -4, rotation: 20 },
    bar_d2_mesial: { x: 20, y: -24, rotation: -3},
    bar_d2_distal: {  x: -55, y: 20, rotation: 1 },
  },
  "13": {
    bar_d1_mesial: { x: -15, y: -17, rotation: 19 },
    bar_d1_distal: { x: -38, y: 15, rotation: -26 },
    bar_d2_mesial: { x: 8, y: -30, rotation: 4 },
    bar_d2_distal: { x: -50, y: 38, rotation: -2 },
  },
  "23": {
    bar_d1_mesial: { x: -15, y: -17, rotation: -19 },
    bar_d1_distal: { x: -37, y: 15, rotation: 26 },
    bar_d2_mesial: { x:  8, y: -30, rotation: -4 },
    bar_d2_distal: { x: -50, y: 38, rotation: 2  },
  },
  "14": {
    bar_d1_mesial: { x: -13, y: -21, rotation: 8 },
    bar_d1_distal: { x: -30, y: 12, rotation: -5 },
    bar_d2_mesial: { x: 4, y: -38, rotation: 6 },
    bar_d2_distal: { x: -39, y: 35, rotation: -3 },
  },
  "24": {
    bar_d1_mesial: { x: -13, y: -21, rotation: -8 },
    bar_d1_distal: { x: -31, y: 13, rotation: 5  },
    bar_d2_mesial: { x: 4, y: -38, rotation: -6  },
    bar_d2_distal: { x: -39, y: 35, rotation: 3 },
  },
  "15": {
    bar_d1_mesial: { x: -18, y: -13, rotation: 8 },
    bar_d1_distal: { x: -33, y: 17, rotation: -5 },
    bar_d2_mesial: { x: -8, y: -31, rotation: 2 },
    bar_d2_distal: { x: -43, y: 70, rotation: -6 },
  },
  "25": {
    bar_d1_mesial: { x: -18, y: -13, rotation: -8 },
    bar_d1_distal: { x: -32, y: 17, rotation: 5 },
    bar_d2_mesial: { x: -8, y: -31, rotation: -2 },
    bar_d2_distal: { x: -42, y: 70, rotation: 7  },
  },
  "16": {
    bar_d1_mesial: { x: -20, y: -5, rotation: 1 },
    bar_d1_distal: { x: -29, y: 38, rotation: -3 },
    bar_d2_mesial: { x: -8, y: -24, rotation: -1 },
    bar_d2_distal: { x: -33, y: 80, rotation: -1 },
  },
  "26": {
    bar_d1_mesial: { x: -22, y: -5, rotation: -1 },
    bar_d1_distal: { x: -29, y: 38, rotation: 3 },
    bar_d2_mesial: { x: -8, y: -24, rotation: 1  },
    bar_d2_distal: { x: -33, y: 80, rotation: -1 },
  },
  "17": {
    bar_d1_mesial: { x: -20, y: -5, rotation: 4 },
    bar_d1_distal: { x: -26, y: 40, rotation: -8 },
    bar_d2_mesial: { x: -2, y: -50, rotation: -1 },
    bar_d2_distal: { x: -13, y: -27, rotation: -3 },
  },
  "27": {
    bar_d1_mesial: { x: -20, y: -5, rotation: -4 },
    bar_d1_distal: { x: -26, y: 40, rotation: 8  },
  ...
  "18": {
    bar_d1_mesial: { x: -13, y: -2, rotation: 15 },
    bar_d2_mesial: { x: -10, y: -52, rotation: 11 },
  },
  "28": {
    bar_d1_mesial: { x: -13, y: -2, rotation: -15 },
    bar_d2_mesial: { x: -10, y: -52, rotation: -11 },
  ...
  "41": {
    bar_d1_mesial: { x: 3, y: 7, rotation: -17 },
    bar_d1_distal: { x: -29, y: 6, rotation: 13 },
    bar_d2_mesial: { x: 23, y: 3, rotation: 9 },
    bar_d2_distal: { x: -40, y: -2, rotation: 8 },
  },
  "31": {
    bar_d1_mesial: { x: 3, y: 7, rotation: 17 },
    bar_d1_distal: { x: -29, y: 6, rotation: -13  },
  ...
  "42": {
    bar_d1_mesial: { x: -4, y: 15, rotation: -17 },
    bar_d1_distal: { x: -29, y: 6, rotation: 13 },
    bar_d2_mesial: { x: 22, y: 20, rotation: -3 },
    bar_d2_distal: { x: -42, y: -5, rotation: 13 },
  },
  "32": {
    bar_d1_mesial: { x: -4, y: 15, rotation: 17 },
    bar_d1_distal: { x: -31, y: 5, rotation: -18 },
    bar_d2_mesial: { x: 22, y: 20, rotation: 3 },
    bar_d2_distal: { x: -42, y: -5, rotation: -13 },
  },
  "43": {
    bar_d1_mesial: { x: -5, y: 17, rotation: -33 },
    bar_d1_distal: { x: -31, y: 5, rotation: -8},
    bar_d2_mesial: { x: 17, y: 22, rotation: -11 },
    bar_d2_distal: { x: -54, y: -30, rotation: -2 },
  },
  "33": {
    bar_d1_mesial: { x: -5, y: 17, rotation: 33 },
    bar_d1_distal: { x: -37, y: -1, rotation: -19 },
    bar_d2_mesial: { x: 17, y: 22, rotation: 11 },
    bar_d2_distal: { x: -54, y: -30, rotation: 2 },
  },
  "44": {
    bar_d1_mesial: { x: -12, y: 17, rotation: -29 },
    bar_d1_distal: { x: -41, y: -12, rotation: 8 },
    bar_d2_mesial: { x: 7, y: 30, rotation: -6 },
    bar_d2_distal: { x: -49, y: -58, rotation: 17 },
  },
  "34": {
    bar_d1_mesial: { x: -12, y: 17, rotation: 29 },
    bar_d1_distal: { x: -41, y: -12, rotation: -8 },
  ...
  "45": {
    bar_d1_mesial: { x: -17, y: 6, rotation: -15 },
    bar_d1_distal: { x: -33, y: -15, rotation: 3 },
    bar_d2_mesial: { x: 5, y: 38, rotation: -8 },
    bar_d2_distal: { x: -43, y: -71, rotation: -1 },
  },
  "35": {
    bar_d1_mesial: { x: -17, y: 9, rotation: 15 },
    bar_d1_distal: { x: -33, y: -15, rotation: -3 },
    bar_d2_mesial: { x: 5, y: 38, rotation: 8 },
    bar_d2_distal: { x: -43, y: -71, rotation: 1 },
  },
  "46": {
    bar_d1_mesial: { x: -20, y: 6, rotation: -12 },
    bar_d1_distal: { x: -29, y: -33, rotation: 4 },
    bar_d2_mesial: { x: -6, y: 32, rotation: -5 },
    bar_d2_distal: { x: -40, y: -75, rotation: 1 },
  },
  "36": {
    bar_d1_mesial: { x: -20, y: 6, rotation: 12 },
    bar_d1_distal: { x: -28, y: -33, rotation: -4 },
    bar_d2_mesial: { x: -6, y: 32, rotation: 5 },
    bar_d2_distal: { x: -39, y: -75, rotation: -1 },
  },
  "47": {
    bar_d1_mesial: { x: -20, y: 6, rotation: -2 },
    bar_d1_distal: { x: -25, y: -32, rotation: 1 },
    bar_d2_mesial: { x: -8, y: 40, rotation: -5 },
  },
  "37": {
    bar_d1_mesial: { x: -22, y: 6, rotation: 2 },
    bar_d1_distal: { x: -25, y: -32, rotation: -1 },
    bar_d2_mesial: { x: -8, y: 40, rotation: 5 },
  },
  "48": {
    bar_d1_mesial: { x: -14, y: 2, rotation: -1 },
    bar_d2_mesial: { x: -7, y: 42, rotation: -3 },
  },
  "38": {
    bar_d1_mesial: { x: -14, y: 2, rotation: 1 },
    bar_d2_mesial: { x: -7, y: 42, rotation: 3 },
