...
public class MultiCircumferentialUIElement : UI_TogglableComponentElement
{
    public int toothFDIID;

	protected override bool PerformChecks(RPDPlaceable rpdComponent, bool isOn)
	{
		return base.PerformChecks(rpdComponent, isOn) && CanPlaceMultiCircumferential();
	}

	bool CanPlaceMultiCircumferential()
	{
